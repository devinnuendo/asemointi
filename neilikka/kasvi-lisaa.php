...
<main>
    <section class="admin">
        ...
        <form autocomplete="on" method="post" id="form-plant" action="kasvi-lisaa-kasittely.php">
            ...
            <fieldset>
                <legend>
                    <?= $traCommon['name'][$lang]; ?> (<?= $traLocal['plant'][$lang]; ?>)</legend>
                <label for="plant">
                    <?= $traCommon['Finnish'][$lang]; ?>: <?= $traLocal['name_plant']['fi']; ?>
                </label>
                <input type="text" name="plant" id="plant" placeholder="<?= $traLocal['name_plant']['fi']; ?>" required />
                <div class="error"></div>

                <label for="plant_sv">
                    <?= $traCommon['Swedish'][$lang]; ?>: <?= $traLocal['name_plant']['sv']; ?>
                </label>
                <input type="text" name="plant_sv" id="plant_sv" placeholder="<?= $traLocal['name_plant']['sv']; ?>" required />
                <div class="error"></div>

                <label for="plant_en">
                    <?= $traCommon['English'][$lang]; ?>: <?= $traLocal['name_plant']['en']; ?>
                </label>
            ...
            <select name="type" id="type" required>
                <option value="cut">
                    <?= $traLocal['plants_cut'][$lang]; ?>
                </option>
                <option value="bunch">
                    <?= $traLocal['flower_bunch'][$lang]; ?>
                </option>
                <option value="pot">
                    <?= $traLocal['plants_pot'][$lang]; ?>
                </option>
            </select>
            <div class="error"></div>

            <label for="img_small">
                <?= $traCommon['filename'][$lang]; ?>: <?= $traCommon['image'][$lang]; ?>, <?= $traCommon['small'][$lang]; ?>
            </label>
            <input type="text" name="img_small" id="img_small" placeholder="<?= $traCommon['filename'][$lang]; ?>.jpg" />
            <div class="error"></div>

            <label for="img_large">
                <?= $traCommon['filename'][$lang]; ?>: <?= $traCommon['image'][$lang]; ?>, <?= $traCommon['big'][$lang]; ?>
            </label>
